...
public class ClaseBase {
	...
	public static AppiumDriver appiumDriverConnetion(String platformName, String deviceName, String platformVersion,
		...
		try {
			...
			logg.info("SE HAN CARGADO LAS CAPABILITYS DE FORMA CORRECTA");
			return driver;
	...
	public void click(By locator, File rutaCarpeta, String evidencia, String mensaje) throws Exception {
		try {
			...
			tiempoEspera(500);
			logg.info("Localizador correcto : " + locator);
	...
	public void validacion(By locator, File rutaCarpeta, String evidencia, String mensaje) throws Exception {
		try {
			try {
				...
				logg.info("Elemento visible : " + locator);
			} catch (Exception e) {
	...
	public void borrar(By locator, File rutaCarpeta, String evidencia, String mensaje) throws Exception {
		try {
			...
			captureScreen(rutaCarpeta, locator, evidencia, mensaje);
			logg.info("Se borra el texto de txt : " + locator);
		} catch (Exception e) {
			captureScreenError(rutaCarpeta, locator, evidencia, e.toString());
			logg.error(e.toString());
			throw new InterruptedException();
	...
	public void sendKey(String string, By locator, File rutaCarpeta, String evidencia, String mensaje)
		...
		try {
			...
			captureScreen(rutaCarpeta, locator, evidencia, mensaje);
			logg.info("Se ingresa el valor en el elemento : " + locator);
		} catch (Exception e) {
			captureScreenError(rutaCarpeta, locator, evidencia, e.toString());
			logg.error(e.toString());
			throw new InterruptedException();
	...
	public void sendKeyValue(String string, By locator, File rutaCarpeta, String evidencia, String mensaje)
		...
		try {
			...
			logg.info("Se reemmplaza el valor en el elemento : " + locator);
		} catch (Exception e) {
			captureScreenError(rutaCarpeta, locator, evidencia, e.toString());
			logg.error(e.toString());
			throw new InterruptedException();
	...
	public void submit(By locator, File rutaCarpeta, String evidencia, String mensaje) throws Exception {
		try {
			...
			tiempoEspera(500);
			captureScreen(rutaCarpeta, locator, evidencia, mensaje);
			logg.info("Sen realiza Submit en el elemento : " + locator);
		} catch (Exception e) {
			captureScreenError(rutaCarpeta, locator, evidencia, e.toString());
			logg.error(e.toString());
			throw new InterruptedException();
	...
	public void tocarPantalla(int x, int y) {
		...
		logg.info("Se hace un touch en las coordenadas : X:" + x + "- Y:" + y);
	}
	...
	public void scrollVertical(File rutaCarpeta, int xini, int yini, int yfinal, int iteraciones) throws Exception {
		...
		logg.info("Se realiza un Scroll vertical ");
	}
	...
	public void enter(File rutaCarpeta, int time) throws Exception {
		...
		tiempoEspera(time);
		logg.info("Se realiza un enter general");
	}
