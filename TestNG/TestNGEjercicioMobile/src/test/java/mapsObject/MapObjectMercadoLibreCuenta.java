...
public class MapObjectMercadoLibreCuenta extends ClaseBase {
	...
	protected By checkboxAceptarTerm = By.xpath(
			"//android.widget.CheckBox[@text='Acepto los Términos y condiciones (abrirá una nueva ventana) y autorizo el uso de mis datos de acuerdo a la Declaración de Privacidad (abrirá una nueva ventana) .']");
