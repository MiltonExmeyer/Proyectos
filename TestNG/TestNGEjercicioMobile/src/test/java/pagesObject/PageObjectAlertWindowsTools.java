...
public class PageObjectAlertWindowsTools extends MapObjectAlertWindowsTools {
	...
	public void alertas(String input, String evidencia, File rutaCarpeta)
		...
		try {
			...
			// ENVIAR IMPUT DESDE EL EXCEL Hoy trasnoche
			sendKey(input, txtInput, rutaCarpeta, evidencia, "Se envia el un valor : " + input);
			// OPCION ACEPTAR
			clickTime(btnAceptar, rutaCarpeta, 2, evidencia, "Se acepta el alert");

			Assert.assertEquals(texto(txtResultado), "You entered " + input);
		} catch (Exception e) {
