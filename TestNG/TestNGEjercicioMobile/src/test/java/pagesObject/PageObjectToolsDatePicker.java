...
public class PageObjectToolsDatePicker extends MapObjectToolsDatePicker {
	...
	public void sistemaDate(File rutaCarpeta, String evidencia) throws Exception, InterruptedException, IOException {
		...
		tiempoEspera(1000);
		// BTN WIDGETS
		clickTime(btnWidgets, rutaCarpeta, 0, evidencia, "Se ingresa a la seccion Widgets");
		// BTN DATA
		clickTime(btnDate, rutaCarpeta, 0, evidencia, "Se ingresa a la opcion Date Picker");
