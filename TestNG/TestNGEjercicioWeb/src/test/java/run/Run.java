...
public class Run {
	...
	@Parameters({ "url", "rutaImagenReporteMercLibre", "rutaImagenReporteTools", "rutaImagenReporteMercury",
			"rutaOutput" })
	public void beforeClass(@Optional("default") String url, @Optional("default") String rutaImagenReporteMercLibre,
			@Optional("default") String rutaImagenReporteTools, @Optional("default") String rutaImagenReporteMercury,
	...
	// INGRESAR A MERCADOLIBRE BUSCAR UN PRODUCTO, SELECCIONAR EL PRIMERO Y CREAR
	// UNA CUENTA
		...
		if (ejecutar.equals("Si")) {
			...
			if (evidencia.equals("Si")) {
				try {
					...
					mercury.formulario(rutaCarpeta, evidencia, firstName, lastName, phone, email, address, city,
							stateProvince, postalCode, country, userName, password, confirmPassword);
					// FINALIZAR GRABACION DE VIDEO
					MyScreenRecorder.stopRecording();
					// FINALILZAR CREACION DEL REPORTE PDF
					generarReportePdf.cerrarPlantilla("La prueba fue Exitosa");
